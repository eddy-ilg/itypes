...
with ds.viz.new_row() as row:
    row.add_cell('image', var='image0').set_ref('../data/scene1/0000-image0.png')
    row.add_cell('image', var='image1').set_ref('../data/scene1/0000-image1.png')
    row.add_cell('flow',  var='flow').set_ref('../data/scene1/0000-flow.flo')

# Second row: show flow and occlusions
with ds.viz.new_row() as row:
    row.skip_cell()
    row.skip_cell()
    row.add_cell('image', var='occ').set_ref('../data/scene1/0000-occ.png')
