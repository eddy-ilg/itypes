...
# combination of two sequences by referencing their data.
#
...
#
ds = Dataset("out_combine_ref/data.json", auto_write=True)
...
ds.var["image0"].copy_from(ds2.var["image0"], mode="ref", indexing="id")
ds.var["image1"].copy_from(ds2.var["image0"], mode="ref", indexing="id")
...
ds.var["flow"].copy_from(ds1.var["flow"], mode="ref", indexing="linear")

# You could also copy all from ds2 by using:
#ds.var.copy_from(ds2.var, mode="ref")
