...
# that is the result of merging two other sequences. The data is copied
# and stored to the new output folder.
#
...
new_seq.write(filename='out_merge_from_sources_copy/data.gridseq')

print("To view run: \"iviz out_merge_from_sources_copy/data.gridseq\"")
print()
